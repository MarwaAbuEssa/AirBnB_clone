...
class TestPlace_init(unittest.TestCase):
    """Unittests for testing init of the Place."""
    ...
    def test_str_representation(self):
        ...
        plstr = pl.__str__()
        self.assertIn("[Place] (159327)", plstr)
        self.assertIn("'id': '159327'", plstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        pl = Place(id="987", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(pl.id, "987")
...
class TestPlace_save(unittest.TestCase):
    """Unittests for testing save Place ."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for testing to_dict Place ."""
    ...
    def test_to_dict_contains_added_attributes(self):
        pl = Place()
        pl.middle_name = "Marwa"
        pl.my_number = 100
        self.assertEqual("Marwa", pl.middle_name)
