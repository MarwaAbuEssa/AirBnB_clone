...
class TestUser_init(unittest.TestCase):
    """Unittests for testing init of user ."""
    ...
    def test_str_representation(self):
        ...
        usstr = us.__str__()
        self.assertIn("[User] (147258)", usstr)
        self.assertIn("'id': '147258'", usstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        us = User(id="698", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(us.id, "698")
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Marwa"
        us.my_number = 98
        self.assertEqual("Marwa", us.middle_name)
