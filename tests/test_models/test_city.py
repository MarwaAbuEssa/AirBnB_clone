...
class TestCity_init(unittest.TestCase):
    """Unittests for testing init of the City."""
    ...
    def test_str_representation(self):
        ...
        cystr = cy.__str__()
        self.assertIn("[City] (256398)", cystr)
        self.assertIn("'id': '256398'", cystr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        cy = City(id="258", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(cy.id, "258")
...
class TestCity_save(unittest.TestCase):
    """Unittests for testing save  City ."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for testing to_dict of City ."""
    ...
    def test_to_dict_contains_added_attributes(self):
        cy = City()
        cy.middle_name = "marwa"
        cy.my_number = 100
        self.assertEqual("marwa", cy.middle_name)
