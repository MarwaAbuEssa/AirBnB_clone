...
class TestReview_init(unittest.TestCase):
    """Unittests for testing init of Review."""
    ...
    def test_str_representation(self):
        ...
        rvstr = rv.__str__()
        self.assertIn("[Review] (147258)", rvstr)
        self.assertIn("'id': '147258'", rvstr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        rv = Review(id="369", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(rv.id, "369")
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        rv = Review()
        rv.middle_name = "Marwa"
        rv.my_number = 98
        self.assertEqual("Marwa", rv.middle_name)
