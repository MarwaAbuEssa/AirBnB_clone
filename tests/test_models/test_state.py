...
class TestState_init(unittest.TestCase):
    """Unittests for testing init state."""
    ...
    def test_str_representation(self):
        ...
        ststr = st.__str__()
        self.assertIn("[State] (147258)", ststr)
        self.assertIn("'id': '147258'", ststr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        st = State(id="968", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(st.id, "968")
...
class TestState_save(unittest.TestCase):
    """Unittests for testing save state."""
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        st = State()
        st.middle_name = "Alexandria"
        st.my_number = 98
        self.assertEqual("Alexandria", st.middle_name)
